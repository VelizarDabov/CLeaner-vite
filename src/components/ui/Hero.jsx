...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[10rem] -translate-x-1/3 lg:-top-[30.375rem] left-1/2 md:w-[68rem] aspect-square    md:-translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        ...
        <div className=" absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[54deg]">
          <div
            className={`hidden md:block w-16 h-16  rounded-full xl:block transit transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}>
                <img src={bubble} alt="bubble"/>
            </div>
        ...
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[85deg]">
          <div
            className={` hidden md:block w-20 h-20  bg-gradient-to-b  rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}>
                <img src={bubble} alt="bubble"/>
            </div>
        ...
        <div className="absolute h-3/2 md:bottom-1/2 left-1/2 w-0.25 md:h-1/2 origin-bottom rotate-[70deg]">
          <div
